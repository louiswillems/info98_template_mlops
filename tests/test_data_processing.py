...
@pytest.fixture
def data_preprocessor(config: dict) -> DataPreprocessor:
    """Create an instance of DataPreprocessor for testing."""
    return DataPreprocessor(FILEPATH, config)


def test_data_preprocessor(data_preprocessor: DataPreprocessor, config: dict) -> None:
    ...
    X_scaled, y, preprocessor = data_preprocessor.get_processed_data()  # noqa: N806
